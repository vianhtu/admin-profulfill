    ...
    if (dt_product_table) {
        var dt_products = new DataTable(dt_product_table, {
            ...
            initComplete: function () {
                ...
                $('.export_save').html('<button class="btn btn-primary" tabindex="1" type="button" style="position: absolute;bottom: 0;right: 0;"><span><i class="fa-solid fa-floppy-disk"></i> <span class="d-none d-sm-inline-block">Save Query</span></span></button>');
