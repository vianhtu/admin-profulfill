                            ...
                            buttons: [
                                {
                                    ...
                                    buttons: [
                                        ...
                                        {
                                            text: '<span class="d-flex align-items-center"><i class="icon-base ti tabler-brand-openai me-1"></i>OpenAI GPT 5 Mini</span>',
                                            className: 'dropdown-item',
                                            action: function (e, dt, node, config) {
                                                actionModel(dt,'gpt-5-mini-2025-08-07', 'openai');
                                            }
                                        }
                                    ]
                                },
